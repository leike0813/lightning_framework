...
class MetricCallback(Callback):
    ...
    def on_load_checkpoint(self, trainer, pl_module, checkpoint):
        self.training_metric_dict = checkpoint['training_metric_dict']
        self.validation_metric_dict = checkpoint['validation_metric_dict']
        self.test_metric_dict = checkpoint['test_metric_dict']
        self.category = checkpoint['category']
        self.append_category_name = checkpoint['append_category_name']
