...
DEFAULT_CONFIG.TRAINING.F1Score = CN(visible=False)
DEFAULT_CONFIG.TRAINING.F1Score.LEVEL = 3
...
DEFAULT_CONFIG.VALIDATION.F1Score = CN(visible=False)
DEFAULT_CONFIG.VALIDATION.F1Score.LEVEL = 2
...
DEFAULT_CONFIG.TEST.CohenKappa = CN(visible=False)
DEFAULT_CONFIG.TEST.CohenKappa.LEVEL = 2

# Since the return of ROC is not a single tensor,
# it will break the logging functionality.
# Thus ROC is better to implement by user manually.

DEFAULT_CONFIG.ROC = CN(visible=False)