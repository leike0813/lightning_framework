...
DEFAULT_CONFIG.TEST_CKPT_TYPE = 'best'
...
DEFAULT_CONFIG.TRAINER.strategy = 'auto'
...
DEFAULT_CONFIG.LOGGER.MLFLOW.checkpoint_path_prefix = 'model/checkpoints' # incompatible with lightning 2.2

DEFAULT_CONFIG.LOGGER.CSVLOGGER = CN()
DEFAULT_CONFIG.LOGGER.CSVLOGGER.save_dir = 'logs'
DEFAULT_CONFIG.LOGGER.CSVLOGGER.name = 'lightning_logs'
DEFAULT_CONFIG.LOGGER.CSVLOGGER.version = None
DEFAULT_CONFIG.LOGGER.CSVLOGGER.prefix = ''
DEFAULT_CONFIG.LOGGER.CSVLOGGER.flush_logs_every_n_steps = 100
DEFAULT_CONFIG.LOGGER.CSVLOGGER.set_typecheck_exclude_keys(['version'])
...
DEFAULT_CONFIG.LOGGER.TAGS.TASK = 'N/A'
DEFAULT_CONFIG.LOGGER.TAGS.TYPE = 'N/A'